...
export function Header({ onAiModeClick }: HeaderProps) {
  return (
    <div className="fixed top-0 left-0 right-0 h-14 border-b border-white/10 bg-[#0f1117]/80 backdrop-blur-xl flex items-center justify-between px-4 sm:px-5 z-50">
