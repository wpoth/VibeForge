...
export function LandingPage({
  ...
  const accentSoft = accentColor?.rgbaSoft ?? "rgba(255, 255, 255, 0.04)";
  const accentMedium = accentColor?.rgbaMedium ?? "rgba(255, 255, 255, 0.1)";
  const accentStrong = accentColor?.rgbaStrong ?? "rgba(255, 255, 255, 0.16)";
                          ...
                          {isPlaying && (
                            <span
                              ...
                              style={{
                                ...
                                boxShadow: `0 0 18px ${accentStrong}`,
                              }}
                            />
                          )}
                        </div>
